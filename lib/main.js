...
var _EE2EE_instances, _EE2EE_client, _EE2EE_byteArrayToBase64, _EE2EE_base64ToByteArray;
const crypto = require('crypto');
export class EE2EE {
    constructor(sPublicKey, bPublicKey) {
    ...
    encrypt(data) {
        let iv = crypto.randomBytes(64), // generate a random iv using nodes crypto module
        cipher = crypto.createCipheriv('aes-256-gcm', this.sharedPrivateKey, iv), // using aes-256-gcm, the shared private key and the iv, create the cipher
    ...
    decrypt(content, tag, iv) {
        ...
        let decipher = crypto.createDecipheriv('aes-256-gcm', this.sharedPrivateKey, iv);
...
_EE2EE_client = new WeakMap(), _EE2EE_instances = new WeakSet(), _EE2EE_byteArrayToBase64 = function _EE2EE_byteArrayToBase64(byteArray) {
